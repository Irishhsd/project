...
BEGIN
	/* Create Tables */
	--Almacena los artículos por carrito
...
BEGIN
  EXEC sys.sp_updateextendedproperty 'MS_Description', 'Almacena los artículos por carrito', 'SCHEMA', 'dbo', 'table', 'Cart_Items'
END 
ELSE
BEGIN
  EXEC sys.sp_addextendedproperty 'MS_Description', 'Almacena los artículos por carrito', 'SCHEMA', 'dbo', 'table', 'Cart_Items'
END
GO

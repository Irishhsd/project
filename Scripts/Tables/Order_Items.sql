...
BEGIN
	/* Create Tables */
	--Almacena información de los elementos de la orden
...
BEGIN
  EXEC sys.sp_updateextendedproperty 'MS_Description', 'Almacena información de los elementos de la orden', 'SCHEMA', 'dbo', 'table', 'Order_Items'
END 
ELSE
BEGIN
  EXEC sys.sp_addextendedproperty 'MS_Description', 'Almacena información de los elementos de la orden', 'SCHEMA', 'dbo', 'table', 'Order_Items'
END
GO
